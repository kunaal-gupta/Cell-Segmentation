...
1. `Create a Difference-of-Gaussian Volume (15%)`: Create a 3-level Difference of Gaussian (DoG) volume by applying the given sigmas in the template A4.py. Some instructions on how to calculate DoG are given in the comments.
...
2. `Obtain a rough estimate of blob center locations (30%)`: Detect regional minima within the DoG volume.
